...
import { FridgePage } from "../pages/fridge/View";
import { ProjectPage } from "../pages/project/View";
import { SampleTypePage } from "../pages/sample-type/View";
import { FridgeViewPage } from "../pages/fridge/FridgeViewPage";
import { FridgeBlockPage } from "../pages/fridge/FridgeBlockPage";
import { SampleSourcePage } from "../pages/sample-source/View";
import { SampleNaturePage } from "../pages/sample-nature/View";
import { SampleConditionPage } from "../pages/sample-condition/View";
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/fridges/open/:uid" element={<FridgeViewPage />} />
      <Route
        path="/fridges/open/block/:uid/:block_uid"
        element={<FridgeBlockPage />}
      />

      {/* settings */}
      <Route path="/settings/projects" element={<ProjectPage />} />

      {/* Samples */}
      <Route path="/samples/types" element={<SampleTypePage />} />
      <Route path="/samples/sources" element={<SampleSourcePage />} />
      <Route path="/samples/natures" element={<SampleNaturePage />} />
      <Route path="/samples/conditions" element={<SampleConditionPage />} />

      <Route path="/settings/directories" element={<DirectoryPage />} />
      <Route
        path="/settings/directory/open/:uid"
